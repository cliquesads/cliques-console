...
angular.module('publisher')
    .constant('BID_FLOOR_SETTINGS', {
        // Set mins & maxes
        min_bid_floor: pricing === 'CPC' ? 0.10 : 1,
        max_bid_floor: pricing === 'CPC' ? 2 : 5
    })
    .constant('PUBLISHER_TOOLTIPS',{
        ...
        bid_floor: "The lowest price at which you're willing to sell impressions on your site, in " + (pricing === "CPC" ? "CPC (Cost per Click)" : "CPM (Cost per Thousand Impressions)") + ". For the best fill rates, we recommend NOT setting this.",
    ...
    .constant('PLACEMENT_TYPES',{
        display: {
            ...
            description: 'Standard IAB Banner ads. Choose from a list of supported dimensions to create a placement with a fixed height & width. ' +
                'In general, display ads yield lower {{ pricing }}\'s, but are easier to implement.',
        ...
        native: {
            ...
            description: 'Ads that are custom-styled to resemble a piece of content on your site. No fixed dimensions & styling is totally custom. ' +
                'Higher {{ pricing }}\'s but slightly more integration work.',
            tagTypes: ['javascript']
        },
        multiPaneNative: {
