...
angular.module('core').controller('AdvertiserDashboardController',
    function($scope, $location, $window, Advertiser, Publisher, DTOptionsBuilder, DTColumnDefBuilder, DailyAdStat,
             HourlyAdStat, MongoTimeSeries, aggregationDateRanges, Authentication, ngDialog, Screenshot, Notify) {
