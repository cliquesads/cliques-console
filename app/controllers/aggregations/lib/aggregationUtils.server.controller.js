...
const filterNumber = function(number, prefix, suffix, lengthOfDecimal, lengthOfSection) {
 ...
 * @constructor
 */
exports.AdStatsAPIHandler = class AdStatsAPIHandler {
    constructor(db){
     ...
     * @private
     */
    _populate(populateQueryString, query_results, group, callback){
     ...
     */
    getManyWrapper(pipelineBuilder, aggregationModel) {
        const self = this;
